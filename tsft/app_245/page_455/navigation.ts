...
export async function acessoAPP245_455(page: Page, context: BrowserContext) {
     await allure.description("Teste de cadastro de Banco Inválido na página APP_245-P_325")
    ...
    // acessa pagina
    await newPage.getByRole('link', { name: ' Formas de Pagamento' }).click();
